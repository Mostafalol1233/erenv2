...
const activity = [
  ...
  { title: "مراجعة جديدة", detail: "سارة م. · Free Fire", amount: "موثّق", time: "منذ 12 دقيقة", icon: MessageSquareText, tone: "purple" },
  { title: "منتج جديد مضاف", detail: "Roblox Credits", amount: "جاهز", time: "منذ 28 دقيقة", icon: Package, tone: "cyan" },
...
export default function AdminPanel() {
  ...
  return <div className="admin-shell" dir="rtl">
    <aside className={`admin-sidebar ${mobileNavOpen ? "open" : ""}`}>
      <div className="admin-sidebar-top"><div className="brand"><img className="admin-brand-logo" src="/images/eren-logo-cinematic-v3.svg" alt="إيرين ستور" /><span><strong>EREN</strong><small>CONTROL CENTER</small></span></div><button className="sidebar-close" onClick={() => setMobileNavOpen(false)}><X /></button></div>
      <div className="workspace-switch"><img className="workspace-avatar workspace-logo" src="/images/eren-logo-cinematic-v3.svg" alt="إيرين ستور" /><div><strong>Eren Store</strong><span>مساحة العمل الرئيسية</span></div><ChevronDown className="h-4 w-4 text-slate-500" /></div>
