...
const siteUrl = "https://erenv2-three.vercel.app"
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: "/images/eren-logo.jpeg", width: 1200, height: 630, alt: "لوجو إيرين ستور" }],
  },
  twitter: {
    ...
    <html lang="ar" dir="rtl">
      <head>
        ...
        <Script id="structured-data" type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
          ...
          url: siteUrl,
          logo: `${siteUrl}/images/eren-logo.jpeg`,
