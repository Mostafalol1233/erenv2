    ...
    return (
      <main className="package-admin-shell package-admin-login" dir="rtl">
        <div className="package-admin-login-card">
          <div className="package-brand-lockup"><img src="/images/eren-logo-premium-transparent.png" alt="Eren" /><span>لوحة ألعاب إيرين</span></div>
  ...
  return (
    <main className="package-admin-shell" dir="rtl">
      <header className="package-admin-topbar">
        <div className="package-brand-lockup"><img src="/images/eren-logo-premium-transparent.png" alt="Eren" /><span>مركز التجارة والألعاب</span></div>
