...
function Logo() {
  return <Link className="eren-logo" href="/" aria-label="إيرين ستور - الصفحة الرئيسية"><img className="eren-logo-image" src="/images/eren-logo-cinematic.png" alt="إيرين" /><span><strong>إيرين</strong><small>متجر اللاعبين</small></span></Link>
}
