...
export const games: Game[] = [
  {
    ...
    name: "PUBG Mobile",
    category: "باتل رويال",
    image: "/images/revamp/pubg-mobile.jpg",
  ...
  },
  {
    ...
    name: "Free Fire",
    category: "موبايل",
    image: "/images/revamp/free-fire.jpg",
  ...
  },
  {
    ...
    category: "تنافسي",
    image: "/images/revamp/valorant-points.jpg",
  ...
  },
  {
    ...
    name: "Mobile Legends",
    category: "موبايل",
    image: "/images/revamp/mobile-legends.jpg",
  ...
  },
  {
    ...
    name: "Roblox Credits",
    category: "موبايل",
    image: "/images/revamp/roblox.jpg",
  ...
  },
  {
    ...
    image: "/images/revamp/steam-wallet.jpg",
  ...
  },
  {
    ...
    name: "CrossFire ZP",
    category: "تصويب",
    image: "/images/revamp/crossfire-zp.jpg",
  ...
  },
  {
    ...
    name: "8 Ball Pool",
    category: "كاجوال",
    image: "/images/revamp/8-ball-pool.jpg",
  ...
  },
  {
    ...
    category: "بطاقات رقمية",
    image: "/images/revamp/discord-effects.jpg",
  ...
  },
  {
    ...
    name: "League RP",
    category: "تنافسي",
    image: "/images/revamp/league-rp.jpg",
  ...
  },
  {
    ...
    category: "باتل رويال",
    image: "/images/revamp/call-of-duty-mobile.jpg",
  ...
  },
  {
    ...
    name: "Fortnite",
    category: "باتل رويال",
    image: "/images/revamp/fortnite.jpg",
  ...
  },
  {
    ...
    name: "EA FC Mobile",
    category: "رياضة",
    image: "/images/revamp/ea-fc-mobile.jpg",
  ...
  },
  {
    ...
    name: "Genshin Impact",
    category: "مغامرات",
    image: "/images/revamp/genshin-impact.jpg",
  ...
  },
  {
    ...
    name: "Brawl Stars",
    category: "موبايل",
    image: "/images/revamp/brawl-stars.jpg",
  ...
  },
  {
    ...
    name: "Minecraft",
    category: "مغامرات",
    image: "/images/revamp/minecraft.jpg",
    description: "ابنِ عالمك واشترِ Minecoins لمحتوى جديد.",
    longDescription: "رصيد Minecoins لعالم Minecraft مع فئات واضحة وخيارات مناسبة للهدايا والمحتوى الإضافي.",
    price: 180,
    rating: 4.8,
    buyers: "360",
    delivery: "10–15 دقيقة",
    badge: "إضافة جديدة",
    fieldLabel: "البريد الإلكتروني أو معرّف الحساب",
    tags: ["مغامرات", "جديد", "رصيد"],
    packages: [pkg("minecraft", 1, "320 Minecoins", 180, "باقة البداية"), pkg("minecraft", 2, "1020 Minecoins", 490, "الأفضل للقيمة"), pkg("minecraft", 3, "1720 Minecoins", 780, "باقة كبيرة"), pkg("minecraft", 4, "3500 Minecoins", 1480, "للعالم الكامل")],
  },
  {
    slug: "apex-legends",
    name: "Apex Legends",
    category: "باتل رويال",
    image: "/images/revamp/apex-legends.jpg",
    description: "Apex Coins لفتح المواسم والعناصر المميزة.",
    longDescription: "اشحن Apex Coins بخيارات متدرجة لتكمل الـ Battle Pass وتختار العناصر التي تناسب أسلوبك.",
    price: 265,
    rating: 4.7,
    buyers: "290",
    delivery: "10 دقائق",
    badge: "جديد",
    fieldLabel: "البريد الإلكتروني أو معرّف الحساب",
    tags: ["باتل رويال", "جديد", "موسم"],
    packages: [pkg("apex", 1, "500 Apex Coins", 265, "باقة البداية"), pkg("apex", 2, "1000 Apex Coins", 505, "الأفضل للقيمة"), pkg("apex", 3, "2150 Apex Coins", 980, "باقة كبيرة"), pkg("apex", 4, "4350 Apex Coins", 1890, "للموسم الكامل")],
  },
  {
    slug: "rocket-league",
    name: "Rocket League",
    category: "رياضة",
    image: "/images/revamp/rocket-league.jpg",
    description: "Credits لسيارتك ومحتوى الملعب القادم.",
    longDescription: "رصيد Credits لمحبي المنافسة الكروية السريعة مع فئات مناسبة للبطاقات والعناصر الموسمية.",
    price: 220,
    rating: 4.7,
    buyers: "250",
    delivery: "10 دقائق",
    badge: "مميز",
    fieldLabel: "البريد الإلكتروني أو معرّف الحساب",
    tags: ["رياضة", "مميز", "بطاقات"],
    packages: [pkg("rocket", 1, "500 Credits", 220, "باقة البداية"), pkg("rocket", 2, "1100 Credits", 455, "الأفضل للقيمة"), pkg("rocket", 3, "3000 Credits", 1120, "باقة كبيرة"), pkg("rocket", 4, "6500 Credits", 2280, "للمحترفين")],
  },
  {
    slug: "stumble-guys",
    name: "Stumble Guys",
    category: "كاجوال",
    image: "/images/revamp/stumble-guys.jpg",
    description: "Gems وPass للجولات السريعة والمحتوى الموسمي.",
    longDescription: "جواهر Stumble Guys للاعبين الذين يريدون فتح عناصر جديدة والاستمرار في المنافسة اليومية.",
    price: 95,
    rating: 4.6,
    buyers: "330",
    delivery: "5–10 دقائق",
    badge: "إضافة جديدة",
    fieldLabel: "معرّف اللاعب",
    tags: ["كاجوال", "جديد", "فوري"],
    packages: [pkg("stumble", 1, "250 Gems", 95, "باقة البداية"), pkg("stumble", 2, "800 Gems", 275, "الأفضل للقيمة"), pkg("stumble", 3, "1600 Gems", 520, "باقة كبيرة"), pkg("stumble", 4, "2800 Gems", 840, "للموسم")],
  },
  {
    slug: "ea-sports-fc-mobile",
    name: "EA Sports FC Mobile",
    category: "رياضة",
    image: "/images/revamp/ea-sports-fc-mobile.jpg",
    description: "FC Points لفريقك وتشكيلتك قبل صافرة البداية.",
    longDescription: "نقاط FC Mobile بخيارات مرتبة لبناء فريقك وفتح الحزم والمحتوى الموسمي بسرعة.",
    price: 160,
    rating: 4.7,
    buyers: "420",
    delivery: "10–15 دقيقة",
    badge: "الأكثر صعوداً",
    fieldLabel: "معرّف اللاعب",
    tags: ["رياضة", "جديد", "فريقك"],
    packages: [pkg("fc-mobile", 1, "105 FC Points", 160, "باقة البداية"), pkg("fc-mobile", 2, "550 FC Points", 520, "الأفضل للقيمة"), pkg("fc-mobile", 3, "1200 FC Points", 1030, "باقة كبيرة"), pkg("fc-mobile", 4, "2500 FC Points", 1980, "للمنافسة")],
  },
]
