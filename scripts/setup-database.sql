...
CREATE INDEX idx_comments_game ON comments(game);
...
('علي حسن', 'CrossFire ZP', 'موقع موثوق وسريع جداً، أشتري منه بشكل منتظم', NOW() - INTERVAL '2 hours'),
('نور محمد', 'Discord Effects', 'الأسعار أرخص من المواقع الأخرى والخدمة سريعة جداً', NOW() - INTERVAL '1 hour');
